    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-8 border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-70 pl-9 pr-3 py-2.5 border ${
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              value={formData.year}
              onChange={handleChange}
              className={`w-33 px-3 py-2.5 border ${
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-72 pl-9 pr-3 py-2.5 border ${
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full mt-4 bg-gradient-to-r ${bgGradient} text-white font-bold py-3 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 ${
