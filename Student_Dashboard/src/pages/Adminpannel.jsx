...
const AdminPanel = () => {
  ...
  // Mock users data
  const mockUsers = [
    { id: 1, name: 'John Doe', email: 'john@example.com', role: 'user', eventsAttended: 12, joinDate: '2024-01-15', status: 'active' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'user', eventsAttended: 8, joinDate: '2024-02-01', status: 'active' },
    { id: 3, name: 'Mike Johnson', email: 'mike@example.com', role: 'admin', eventsAttended: 25, joinDate: '2023-11-10', status: 'active' },
    { id: 4, name: 'Sarah Wilson', email: 'sarah@example.com', role: 'user', eventsAttended: 5, joinDate: '2024-02-20', status: 'inactive' },
    { id: 5, name: 'David Brown', email: 'david@example.com', role: 'user', eventsAttended: 15, joinDate: '2024-01-05', status: 'active' },
  ]
  ...
  const handleCreateEvent = async () => {
    ...
    try {
      const newEvent = {
        ...
        id: Date.now(),
        attendees: 0,
        image: formData.image || 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4'
      }
  ...
  const getStats = () => {
    ...
    return { totalEvents, upcomingEvents, totalAttendees, activeUsers, totalRevenue }
  }
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {filteredEvents.map(event => (
                        <tr key={event.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="text-sm text-gray-900">{event.attendees}</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex space-x-2">
                              ...
                              <button
                                onClick={() => toast(`Viewing ${event.title} details`)}
                  ...
                  <div key={user.id} className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={() => toast(`Sending email to ${user.email}`)}
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-semibold text-gray-800">{user.eventsAttended}</span>
                      </div>
                      <div>
                        <span className="text-gray-500">Joined:</span>
                        <span className="ml-2 text-gray-600">{user.joinDate}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">Send email notifications for new event registrations</span>
                  </label>
                  <label className="flex items-center space-x-3">
                    <input type="checkbox" defaultChecked className="w-4 h-4 text-primary-600" />
                    <span className="text-gray-700">Send weekly digest emails to users</span>
                  </label>
                  <label className="flex items-center space-x-3">
